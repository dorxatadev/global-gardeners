...
function CheckBadge() {
  return (
    <div className="relative flex h-[120px] w-[120px] items-center justify-center">
      <div className="absolute inset-0 rounded-full bg-[#dfe4d8]" />
      <div className="relative flex h-[86px] w-[86px] items-center justify-center rounded-full bg-[#60ac5b]">
        <Image alt="" aria-hidden="true" src="/icons/onboarding-check.svg" width={28} height={28} />
      </div>
    </div>
  );
}
        ...
        <header className="client-header fixed left-0 right-0 top-0 z-30 flex w-full items-center border-b border-black/10 bg-white p-4">
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={() => router.push("/settings/experience/loading")}
            >
              <BackIcon />
            </button>
        ...
        <div className="flex flex-1 items-center justify-center px-4 pt-[74px]">
          <div className="flex w-full max-w-[358px] flex-col items-center gap-10">
            ...
            <div className="flex w-full flex-col items-center gap-2 text-center">
              <h1 className="text-[24px] font-semibold leading-[28.8px] tracking-[-1px] text-[#182a17]">Your garden is ready!</h1>
              <p className="w-full text-[16px] font-medium leading-6 text-[#333333cc]">
                We&apos;ve personalized your experience with tips, guides, and insights just for you.
              </p>
            </div>
          </div>
        </div>
